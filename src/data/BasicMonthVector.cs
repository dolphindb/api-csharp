...
namespace dolphindb.data
{
    ...
    public class BasicMonthVector : BasicIntVector
    {
        ...
        public override void set(int index, string value)
        {
            ...
            {
                if(0<=v && v<= 119999)//Utils.countMonths(9999, 12)
                {
            ...
            setNull(index);
            Console.WriteLine("[Warning]:Invalid value " + value + " for set(int index, string value) function and the value is set to null. Valid value must be [YYYY:MM] or [MM] format.");
        }
