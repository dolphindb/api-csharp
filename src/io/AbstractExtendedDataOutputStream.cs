...
namespace dolphindb.io
{
    ...
    public abstract class AbstractExtendedDataOutputStream : BinaryWriter, ExtendedDataOutput
    {
        ...
        protected static readonly int doubleBufSize = BUF_SIZE / 8;
    ...
    public void writeDouble2Array(Double2[] A)
    {
    ...
    public abstract void writeDouble2Array(Double2[] A, int startIdx, int len);
        ...
        public abstract void writeDouble2(Double2 v);
