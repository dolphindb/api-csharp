...
* ignoreNull: a Boolean value. It is used to specify the parameter ignoreNull of [upsert!](https://www.dolphindb.com/help/FunctionsandCommands/FunctionReferences/u/upsert%21.html), indicating whether to update the NULL values of the target table.
...
```
Subscribe to a Heterogeneous Table <!-- omit in toc -->
