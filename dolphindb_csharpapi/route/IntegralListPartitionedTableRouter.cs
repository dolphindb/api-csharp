...
namespace com.xxdb.route
{
	...
	internal class IntegralListPartitionedTableRouter : TableRouter
	{
		private IDictionary<long?, IList<string>> locationMap;
		...
		public virtual string route(Scalar partitionColumn)
		{
			...
			try
			{
				...
				IList<string> locations = locationMap[longVal];
				if (locations == null)
				{
