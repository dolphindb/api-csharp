...
namespace dolphindb_csharp_api_test.data_test
{
    ...
    public class Util_test
    {
        ...
        public void test_Utils_getDataTypeString()
        {
            ...
            Assert.AreEqual("data type 25", Utils.getDataTypeString(DATA_TYPE.DT_ANY));
            ...
            Assert.AreEqual("DECIMAL128", Utils.getDataTypeString(DATA_TYPE.DT_DECIMAL128));
        }
        [TestMethod]
        ...
        public void test_Utils_toMonth_Scalar()
        {
            ...
            Assert.AreEqual("2012.06M", Utils.toMonth((IEntity)conn.run("datehour(2012.06.15 15:32:10.158)")).ToString());
            Assert.AreEqual("2017.04M", Utils.toMonth((IEntity)conn.run("2017.04.02")).ToString());
        }
        [TestMethod]
