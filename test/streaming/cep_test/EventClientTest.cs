...
//                String decimal32v = attributes[22].getString().Replace(",,", ",NULL,").Replace("[,", "[NULL,").Replace(",]", ",NULL]").Replace(',', ' ');
//                String decimal64v = attributes[23].getString().Replace(",,", ",NULL,").Replace("[,", "[NULL,").Replace(",]", ",NULL]").Replace(',', ' ');
//                String decimal128v = attributes[24].getString().Replace(",,", ",NULL,").Replace("[,", "[NULL,").Replace(",]", ",NULL]").Replace(',', ' ');
...
//            public void doEvent(String eventType, List<IEntity> attributes)
//            {
//                String decimal32v = attributes[0].getString().Replace(",,", ",NULL,").Replace("[,", "[NULL,").Replace(",]", ",NULL]").Replace(',', ' ');
//                String decimal64v = attributes[1].getString().Replace(",,", ",NULL,").Replace("[,", "[NULL,").Replace(",]", ",NULL]").Replace(',', ' ');
//                String decimal128v = attributes[2].getString().Replace(",,", ",NULL,").Replace("[,", "[NULL,").Replace(",]", ",NULL]").Replace(',', ' ');
...
//                }
//                String script = null;
//                script = String.Format("insert into outputTable values( {0},{1},{2})", decimal32v, decimal64v, decimal128v);
//                conn.run(script);
//            }
//        };
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("eventSchema must be non-null and non-empty.", re);
//        }
...
//        [TestMethod]
//        public void test_EventClient_EventType_null_1()
//        {
...
//        [TestMethod]
//        public void test_EventClient_fieldNames_null()
//        {
//            EventSchema scheme = new EventSchema("market", new List<string> { "", "market", "time3", "time2", "time3" }, new List<DATA_TYPE> { DATA_TYPE.DT_STRING, DATA_TYPE.DT_TIME, DATA_TYPE.DT_TIME, DATA_TYPE.DT_TIME, DATA_TYPE.DT_TIME }, new List<DATA_FORM> { DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR });
//            List<EventSchema> eventSchemas = new List<EventSchema>();
//            eventSchemas.Add(scheme);
//            List<String> eventTimeFields = new List<string>() { "market" };
//            List<String> commonFields = new List<string>();
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("eventKey in eventSchema must be non-empty.", re);
//        }
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("EventSchema cannot has duplicated fieldName in fieldNames.", re);
//        }
...
//            conn.run(script);
//            EventSchema scheme = new EventSchema("market", new List<string> { "timestamp" }, new List<DATA_TYPE> { DATA_TYPE.DT_TIMESTAMP }, new List<DATA_FORM> { DATA_FORM.DF_SCALAR });
//            List<EventSchema> eventSchemas = new List<EventSchema>();
//            eventSchemas.Add(scheme);
...
//        [TestMethod]
//        public void test_EventClient_FieldTypes_null()
//        {
...
//        [TestMethod]
//        public void test_EventClient_FieldTypes_not_support()
//        {
//            EventSchema scheme = new EventSchema("market", new List<string> { "market", "code", "price", "qty", "eventTime" }, new List<DATA_TYPE> { DATA_TYPE.DT_VOID, DATA_TYPE.DT_STRING, DATA_TYPE.DT_DOUBLE, DATA_TYPE.DT_INT, DATA_TYPE.DT_TIMESTAMP }, new List<DATA_FORM> { DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR, DATA_FORM.DF_SCALAR });
//            List<EventSchema> eventSchemas = new List<EventSchema>();
//            eventSchemas.Add(scheme);
//            List<String> eventTimeFields = new List<string>();
//            List<String> commonFields = new List<string>();
...
//        [TestMethod]
//        public void test_EventClient_FieldForms_null()
//        {
...
//        [TestMethod]
//        public void test_EventClient_eventTimeFields_not_time_column()
//        {
...
//            Assert.AreEqual("10:45:03.100", re.getColumn(2).get(0).getString());
//            Assert.AreEqual("12:45:03.100", re.getColumn(2).get(1).getString());
...
//                re = ex.Message;
//            }
//            Assert.AreEqual(true, re.Contains("The shared table inputTable111 doesn't exist."));
//        }
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("EventClient subscribe 'tableName' param cannot be null or empty.", re);
//            String re1 = null;
//            try
//            {
...
//                re1 = ex.Message;
//            }
//            Assert.AreEqual("EventClient subscribe 'tableName' param cannot be null or empty.", re1);
//        }
...
//            client.unsubscribe(SERVER, PORT, "inputTable", null);
//        }
...
//                Console.Out.WriteLine(pt.getDataType());
//                Console.Out.WriteLine(j + "列：" + pt.getObject().ToString());
//                attributes.Add(pt);
//            }
//            sender.sendEvent("event_all_array_dateType", attributes);
//            BasicTable bt1 = (BasicTable)conn.run("select * from inputTable;");
