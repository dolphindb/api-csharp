...
//            try { client.unsubscribe(SERVER, PORT, "inputTable", "javaStreamingApi"); } catch (Exception ex) { }
//            try { client.unsubscribe(SERVER, PORT, "intput", "javaStreamingApi"); } catch (Exception ex) { }
//            clear_env();
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("eventType must not be empty.", re);
//        }
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("fieldName must be non-null and non-empty.", re);
//        }
...
//        [TestMethod]
//        public void test_EventSender_FieldTypes_not_support()
//        {
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("Compression Failed: only support integral and temporal data, not support DT_VOID.", re);
//        }
...
//        [TestMethod]
//        public void test_EventSender_FieldForms_null_1()
//        {
...
//        [TestMethod]
//        public void test_EventSender_FieldForms_not_support()
//        {
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("attrForm only can be DF_SCALAR or DF_VECTOR.", re);
//        }
...
//            List<String> commonFields = new List<string>() { "time", "market" };
//            String re = null;
//            EventSender sender1 = new EventSender(conn, null, eventSchemas, eventTimeFields, commonFields);
...
//                re = ex.Message;
//            }
//            Assert.AreEqual(true, re.Contains("FROM clause must return a table."));
//            String re1 = null;
//            try
//            {
...
//                re1 = ex.Message;
//            }
//            Assert.AreEqual(true, re1.Contains("select top 0 * from "));
//        }
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("Incompatible inputTable1 columns, expected: 2, got: 3", re);
//        }
...
//                re = ex.Message;
//            }
//            Assert.AreEqual("Value cannot be null. (Parameter 'eventType')", re);
//            String re1 = null;
//            try
//            {
...
//        [TestMethod]
//        public void test_EventClient_decimal_1()
//        {
//            String script = "share streamTable(1000000:0, `eventType`event, [STRING,BLOB]) as inputTable;\n" +
...
//        [TestMethod]
//        public void test_EventClient_vector_decimal_1()
//        {
//            String script = "share streamTable(1000000:0, `eventType`event, [STRING,BLOB]) as inputTable;\n" +
//                    "share table(1:0,[\"col1\"],[DECIMAL32(2)[]]) as outputTable;\n";
//            conn.run(script);
...
//            EventSchema scheme = new EventSchema("event_all_array_dateType", new List<string> { "decimal32v" }, new List<DATA_TYPE> { DATA_TYPE.DT_DECIMAL32 }, new List<DATA_FORM> { DATA_FORM.DF_VECTOR }, new List<int> { 2 });
//            List<EventSchema> eventSchemas = new List<EventSchema>();
//            eventSchemas.Add(scheme);
//            List<String> eventTimeFields = new List<string>();
//            List<String> commonFields = new List<string>();
...
//            conn.run(script2);
//            List<IEntity> attributes = new List<IEntity>();
//            attributes.Add(new BasicSymbolVector(new String[] { "111", "222", "", "" }));
